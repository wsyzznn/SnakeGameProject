...
public class PlayerInputTypeSupport extends TypeSupport {
    private String type_name = "PlayerInput";
    private static TypeCodeImpl s_typeCode = null;
    private static PlayerInputTypeSupport m_instance = new PlayerInputTypeSupport();
    ...
    public int copy_sampleI(Object dst,Object src) {
        PlayerInput PlayerInputDst = (PlayerInput)dst;
        PlayerInput PlayerInputSrc = (PlayerInput)src;
        PlayerInputDst.copy(PlayerInputSrc);
        return 1;
    }
    ...
    public int print_sample(Object _sample) {
        ...
        PlayerInput sample = (PlayerInput)_sample;
    ...
    public DataReader create_data_reader() {return new PlayerInputDataReader();}

    public DataWriter create_data_writer() {return new PlayerInputDataWriter();}
    ...
    public TypeCode get_typecode(){
        ...
        s_typeCode = factory.create_struct_TC("SnakeGame.PlayerInput");
        if (s_typeCode == null){
            System.out.println("create struct PlayerInput typecode failed.");
            return s_typeCode;
        }
        int ret = 0;
